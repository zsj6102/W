...
public class GridViewPager extends RelativeLayout  {
    ...
    public GridViewPager init(List<Map<String,Object>> list) {
        mData = list;
        //总的页数=总数/每页数量，并取整
        ...
        for (int i = 0; i < pageCount; i++) {
            //每个页面都是inflate出一个新实例
            mAdapter = new GridViewAdapter(mContext, mData, i, pageSize );
            gridView = (GridView) inflater.inflate(R.layout.gridview, mPager, false);
            ...
            gridView.setOnItemClickListener(new AdapterView.OnItemClickListener() {
                ...
                public void onItemClick(AdapterView<?> parent, View view, int pos, long id) {
                    ...
                    gridItemClickListener.click(pos, position);
                }
            });
            ...
            gridView.setOnItemLongClickListener(new AdapterView.OnItemLongClickListener() {
                ...
                public boolean onItemLongClick(AdapterView<?> parent, View view, int pos, long id) {
                    if (gridItemLongClickListener == null) return false;
                        ...
                        int position = pos + curIndex * pageSize;
                        gridItemLongClickListener.click(pos, position);
                        return true;
                    }
                }
            });
